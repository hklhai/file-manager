...
public class FileVersion implements Serializable {
    private static final long serialVersionUID = -227958813051899281L;
    @Id
    ...
    @Basic
    @Column(name = "fileversionid", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(fileversionid, that.fileversionid) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(fileversionid, fileid, filename, filerealname, filesize, userid, username, createdate, editdate, fileversion, filepath);
    }
}
